...
const ordered = inventors.sort((firstInventor, secondInventor) => firstInventor.year > secondInventor.year ? 1 : -1);
...
const oldest = inventors.sort((firstInventor, secondInventor) => {
    return ((firstInventor.passed - firstInventor.year) < (secondInventor.passed - secondInventor.year) ? 1 : -1);
});
